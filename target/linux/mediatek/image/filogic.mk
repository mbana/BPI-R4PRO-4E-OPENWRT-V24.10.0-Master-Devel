...
define Device/bananapi_bpi-r4-pro-4e-common
  DEVICE_VENDOR := Bananapi
  DEVICE_DTS_DIR := $(DTS_DIR)/
  DEVICE_DTS_LOADADDR := 0x45f00000
  DEVICE_DTS_OVERLAY:= mt7988a-bananapi-bpi-r4-pro-4e-emmc mt7988a-bananapi-bpi-r4-pro-4e-rtc mt7988a-bananapi-bpi-r4-pro-4e-sd mt7988a-bananapi-bpi-r4-pro-4e-iphy mt7988a-bananapi-bpi-r4-pro-4e-sfp mt7988a-bananapi-bpi-r4-pro-4e-wifi-mt7996a
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_PACKAGES := kmod-hwmon-pwmfan kmod-i2c-mux-pca954x kmod-eeprom-at24 kmod-mt7996-firmware kmod-mt7996-233-firmware \
		     kmod-rtc-pcf8563 kmod-sfp kmod-usb3 e2fsprogs f2fsck mkf2fs mt7988-wo-firmware
  IMAGES := sysupgrade.itb
  ...
  ARTIFACT/snand-preloader.bin  := mt7988-bl2 spim-nand-ubi-comb
  ARTIFACT/snand-bl31-uboot.fip := mt7988-bl31-uboot $$(DEVICE_NAME)-snand
  UBINIZE_PARTS := fip=:$(STAGING_DIR_IMAGE)/mt7988_bananapi_bpi-r4-pro-4e-snand-u-boot.fip
  UBINIZE_PARTS += recovery=:$(STAGING_DIR_IMAGE)/mediatek-filogic-bananapi_bpi-r4-pro-4e-initramfs-recovery.itb
...
define Device/bananapi_bpi-r4-pro-4e
  ...
  $(call Device/bananapi_bpi-r4-pro-4e-common)
endef
